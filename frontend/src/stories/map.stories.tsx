...
function CallNormalGourmentMap() {
  ...
  return <GourmetMap zoomValue={7} markers={markers} setMarkers={setMarkers} parentShops={normalShops} />;
}
...
function CallUsingGourmetMap() {
  ...
  return <GourmetMap zoomValue={12.2} markers={markers} setMarkers={setMarkers} parentShops={usingShops} />;
}
